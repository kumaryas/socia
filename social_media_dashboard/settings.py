...
INSTALLED_APPS = [
    ...
    'users',  # Your app for user-related views
    'dashboard'  # Your app for dashboard views
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates')],  # Your main templates directory
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
